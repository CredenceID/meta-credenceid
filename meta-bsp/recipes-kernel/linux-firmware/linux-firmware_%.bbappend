...
SRC_URI += "git@github.com:PavanNittala/credenceid-yocto.git;protocol=https;branch=${SRCBRANCH} mickledore;name=credenceid;destsuffix=credenceid"

do_install:append () {
    install -m 0644 ${WORKDIR}/credenceid/linux-firmware/bluetooth/BCM4362A2_001.003.006.1132.1255.hcd ${D}${nonarch_base_libdir}/firmware/
}
